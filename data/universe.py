...
NIFTY_500_SYMBOLS = [
    ...
    # Nifty Next 50
    "ADANIGREEN.NS","ADANIENSOL.NS","AMBUJACEM.NS","AUROPHARMA.NS","BANDHANBNK.NS",
    ...
    "MANKIND.NS","MPHASIS.NS","NAUKRI.NS","OBEROIRLTY.NS","OFSS.NS",
    ...
    "UPL.NS","VEDL.NS","VOLTAS.NS","WHIRLPOOL.NS","ETERNAL.NS",
    # Mid-cap liquid
    ...
    "GMRAIRPORT.NS","GODREJIND.NS","GODREJPROP.NS","GRANULES.NS","GSPL.NS",
    ...
    "MFSL.NS","ANGELONE.NS","MOTHERSON.NS","MUTHOOTFIN.NS","NATIONALUM.NS",
